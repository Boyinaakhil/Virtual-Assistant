  ...
  return (
    <div className='w-full h-[100vh]
     ...
     flex justify-center items-center flex-col p-[20px]'>
      ...
      <h1 className='text-white text-[30px] mb-[30px] text-center'>Select your
      ...
      items-center flex-wrap gap-[15px]'>
        ...
        <input type = "file" accept='image/*' ref={inputImage}
        hidden onChange={handleImage}/>
      </div>
      {selectedImage && <button className='min-w-[150px] mt-[30px] h-[60px] bg-white rounded-full
