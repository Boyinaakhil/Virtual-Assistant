...
function Customize2() {
  const {userData,backendImage,selectedImage,serverUrl
    ,setUserData
  ...
  return (
    <div className='w-full h-[100vh]
     ...
     flex justify-center items-center flex-col p-[20px] relative'>
      ...
      <input type = "type" placeholder='eg. shifra' 
        ...
        value = {assistantName}
        />
      {assistantName && <button className='min-w-[300px] mt-[30px] h-[60px] bg-white rounded-full
